 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = PI * (deg + min / 60.0+sec / 60.0 / 60.0) / 180.0
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial * cube(1 + percent / 100.0)
